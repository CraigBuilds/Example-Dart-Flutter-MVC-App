...
class RoutingAndControllerConfig<Model> {
  ...
  //programmatically return a map of strings to widget builders based on the config. This is where we map:
  //Which routes go to which views
  //Which Views get which controllers
  ...
  Map<String, WidgetBuilder> buildRoutes() {
    ...
    routesToViewsAndControllers.forEach((routeN, viewAndControllerBuilderN) {
      ...
      final controllerBuilderN = viewAndControllerBuilderN.controllerBuilder; 
      ...
      final widgetBuilderN = (_) {
        ...
        final viewN = viewBuilderN(model, controllerN);
        debugPrint('Built view for route $routeN: $viewN');
        return viewN;
      };
      debugPrint('Assigning $widgetBuilderN to route $routeN');
      routes[routeN] = widgetBuilderN;
      debugPrint('Assigned $widgetBuilderN to route $routeN');
    });
    return routes;
  }
